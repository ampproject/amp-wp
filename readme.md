...
![Theme selection to enhance Reader mode experience.](wp-assets/screenshot-3.png)
...
![Customize AMP Pages from customizer settings for Reader Mode.](wp-assets/screenshot-5.png)

### Reopen the settings wizard, change the template mode, or change advanced settings.

![Reopen the settings wizard, change the template mode, or change advanced settings.](wp-assets/screenshot-6.png)
