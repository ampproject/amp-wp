## Class `AmpProject\AmpWP\Validation\ScannableURLProvider`

ScannableURLProvider class.

### Methods

* [`__construct`](../method/Validation/ScannableURLProvider/__construct.md) - Class constructor.
* [`get_urls`](../method/Validation/ScannableURLProvider/get_urls.md) - Provides the array of URLs to check.
### Source
