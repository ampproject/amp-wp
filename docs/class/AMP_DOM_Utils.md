...
* [`create_node`](../method/AMP_DOM_Utils/create_node.md) - Create a new node w/attributes (a DOMElement) and add to the passed Dom\Document.
* [`get_node_attributes_as_assoc_array`](../method/AMP_DOM_Utils/get_node_attributes_as_assoc_array.md) - Extract a DOMElement node&#039;s HTML element attributes and return as an array.
* [`add_attributes_to_node`](../method/AMP_DOM_Utils/add_attributes_to_node.md) - Add one or more HTML element attributes to a node&#039;s DOMElement.
* [`is_node_empty`](../method/AMP_DOM_Utils/is_node_empty.md) - Determines if a DOMElement&#039;s node is empty or not.
* [`has_class`](../method/AMP_DOM_Utils/has_class.md) - Check whether a given element has a specific class.
* ~~[`get_element_id`](../method/AMP_DOM_Utils/get_element_id.md) - Get the ID for an element.~~
* [`add_amp_action`](../method/AMP_DOM_Utils/add_amp_action.md) - Register an AMP action to an event on a given element.
* [`merge_amp_actions`](../method/AMP_DOM_Utils/merge_amp_actions.md) - Merge two sets of AMP events &amp; actions.
