...
- Fix content smooth scrolling in Twenty Seventeen theme. [#1777](https://github.com/ampproject/amp-wp/pull/1777). Props westonruter.
...
- Prevent re-bundling WordPress packages which are shipped in 5.0.  See [#1781](https://github.com/ampproject/amp-wp/pull/1781). Props westonruter, flixos90 (felixarntz).
