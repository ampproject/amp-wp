	...
	public function render_notice() {
		...
		<div class="amp-plugin-notice notice notice-info is-dismissible" id="<?php echo esc_attr( self::NOTICE_ID ); ?>">
			...
			<div>
				...
				<p><?php esc_html_e( 'Bring the speed and capabilities of the AMP web framework to your site; support content authoring and website development with the effective tools AMP provides.', 'amp' ); ?></p>
				...
				<?php else : ?>
					<p><a href="<?php menu_page_url( AMP_Options_Manager::OPTION_NAME ); ?>"><?php esc_html_e( 'Open the onoarding wizard', 'amp' ); ?></a></p>
				<?php endif; ?>
			</div>
		</div>
