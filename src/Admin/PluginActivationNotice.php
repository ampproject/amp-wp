	...
	public function render_notice() {
		...
		<div class="amp-plugin-notice notice notice-info is-dismissible" id="<?php echo esc_attr( self::NOTICE_ID ); ?>">
			...
			<div>
				...
				<p><?php esc_html_e( 'Bring the speed and capabilities of the AMP web framework to your site, and effective tools to support content authoring and website development with AMP.', 'amp' ); ?></p>
