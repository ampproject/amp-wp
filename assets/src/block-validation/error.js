...
function ErrorTypeIcon( { type } ) {
	...
	switch ( type ) {
		...
		case HTML_ELEMENT_ERROR_TYPE:
			return (
				<svg className="amp-error__html-error-icon" width="15" height="5" viewBox="0 0 15 5" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		case JS_ERROR_TYPE:
			return (
				<svg className="amp-error__js-error-icon" width="12" height="9" viewBox="0 0 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		case CSS_ERROR_TYPE:
			return (
				<svg className="amp-error__css-error-icon" width="8" height="9" viewBox="0 0 8 9" fill="none" xmlns="http://www.w3.org/2000/svg">
