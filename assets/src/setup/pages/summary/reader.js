...
export function Reader( { currentTheme } ) {
	...
	const mobileCaption = mobileRedirect ? __( 'Illustration of what mobile and AMP visitors will see.', 'amp' ) : __( 'Illustration of AMP visitors will see.', 'amp' );
	const desktopCaption = mobileRedirect ? __( 'Illustration of what desktop visitors will see (without your customizations).', 'amp' ) : __( 'Illustration of what desktop and non-AMP mobile visitors will see (without your customizations).', 'amp' );
