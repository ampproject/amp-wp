...
function getDescription( mode ) {
	switch ( mode ) {
		case 'reader':
			return __( 'Your site is using Reader mode. Pages for the AMP version of your site will be served using the reader theme you have selected (shown to the right), while pages for the non-AMP version of your site will be served using your currently active theme.', 'amp' );
