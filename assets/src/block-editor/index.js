...
import { addAMPAttributes, addToolbarButtonToBlock, filterBlocksSave } from './helpers';
import './store';
...
addFilter( 'editor.BlockEdit', 'ampEditorBlocks/filterEdit', addToolbarButtonToBlock, 20 );
