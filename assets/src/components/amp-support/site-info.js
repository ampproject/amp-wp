				...
				<ListItems
					...
					items={[
						...
						},
						{
							...
							value: siteInfo?.is_defined_curl_multi
								? 'Yes'
								: 'No',
						},
					]}
				...
				<ListItems
					...
					items={[
						...
						},
						{
							...
							value: siteInfo?.amp_plugin_configured
								? 'Yes'
								: 'No',
						},
						{
							label: __('AMP all templates supported', 'amp'),
							value: siteInfo?.amp_all_templates_supported
								? 'Yes'
								: 'No',
						},
						{
							label: __('AMP supported post types', 'amp'),
							value: siteInfo?.amp_supported_post_types
								? siteInfo.amp_supported_post_types.join(', ')
								: '',
						},
						{
							label: __('AMP supported templates', 'amp'),
							value: siteInfo?.amp_supported_templates
								? siteInfo.amp_supported_templates.join(', ')
								: '',
						},
						{
