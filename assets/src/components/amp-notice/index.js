	...
	switch (type) {
		case NOTICE_TYPE_SUCCESS:
			Icon = () => (
				...
				>
					...
					>
						<path
							d="M15.0921 21.461L11.3924 17.7613L10.1326 19.0122L15.0921 23.9718L25.7387 13.3252L24.4877 12.0742L15.0921 21.461Z"
							fill="white"
						/>
					</mask>
		...
		case NOTICE_TYPE_ERROR:
			Icon = () => (
				...
				>
					<path
						d="M8.18125 16.1001L16.4324 7.84902L28.1012 7.84902L36.3523 16.1001L36.3523 27.769L28.1012 36.0201L16.4324 36.0201L8.18125 27.769L8.18125 16.1001Z"
						stroke="#EF0000"
						strokeWidth="2"
					/>
					<path
						d="M24.2671 27.4609C24.2671 28.5654 23.3716 29.4609 22.2671 29.4609C21.1626 29.4609 20.2671 28.5654 20.2671 27.4609C20.2671 26.3564 21.1626 25.4609 22.2671 25.4609C23.3716 25.4609 24.2671 26.3564 24.2671 27.4609Z"
						fill="#EF0000"
					/>
					<line
						x1="22.2891"
		...
		default:
			Icon = () => (
				...
				>
					...
					/>
					<path
						d="M15.3048 11.3424C15.3048 10.1875 16.2412 9.25113 17.3961 9.25113C18.5509 9.25113 19.4873 10.1875 19.4873 11.3424C19.4873 12.4972 18.5509 13.4336 17.3961 13.4336C16.2412 13.4336 15.3048 12.4972 15.3048 11.3424Z"
						fill="currentColor"
					/>
					<line
						x1="17.4184"
