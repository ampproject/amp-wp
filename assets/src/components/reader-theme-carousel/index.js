...
export function ReaderThemeCarousel() {
	...
	const [includeUnavailableThemes, setIncludeUnavailableThemes] =
		useState(false);
	...
	return (
		<div className="reader-theme-selection">
			<p>
				{__(
					'Choose the theme to be used for AMP pages. This theme will normally be exclusively shown to mobile visitors.',
					'amp'
				)}
			</p>
			...
			<div>
				{hasUnavailableThemes && (
					<AMPNotice type={NOTICE_TYPE_INFO}>
						<p>
							{__(
								'Some supported themes cannot be installed automatically on this site. To use, please install them manually or contact your hosting provider.',
								'amp'
							)}
						</p>
						<AMPSettingToggle
