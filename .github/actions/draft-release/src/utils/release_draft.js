...
import paginateByPath from './paginate_by_path';
...
export default class ReleaseDraft {
	...
	generate() {
		const data = paginateByPath(github.graphql, findIssuesWithinMilestoneQuery, this.graphQlVariables, ['search']);
