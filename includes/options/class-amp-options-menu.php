...
class AMP_Options_Menu {
	...
	public function render_theme_support() {
		...
		$native_description       = __( 'Integrates AMP as the framework for your site by using the active’s theme templates and styles to render AMP responses. This means your site is <b>AMP-first</b> and your canonical URLs are AMP! Depending on your theme/plugins, a varying level of <a href="https://amp-wp.org/documentation/developing-wordpress-amp-sites/">development work</a> may be required.', 'amp' );
		$transitional_description = __( 'Uses the active theme’s templates to generate non-AMP and AMP versions of your content, allowing for each canonical URL to have a corresponding (paired) AMP URL. This mode is useful to progressively transition towards a fully AMP-first site. Depending on your theme/plugins, a varying level of <a href="https://amp-wp.org/documentation/developing-wordpress-amp-sites/">development work</a> may be required.', 'amp' );
