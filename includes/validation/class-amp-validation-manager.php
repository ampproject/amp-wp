...
class AMP_Validation_Manager {
	...
	public static function post_supports_validation( $post ) {
		...
		if ( AMP_Story_Legacy_Post_Type::POST_TYPE_SLUG === $post->post_type || AMP_Story_Post_Type::POST_TYPE_SLUG === $post->post_type ) {
	...
	public static function enqueue_block_validation() {
		...
		$should_enqueue_block_validation = (
			...
			(
				...
				||
				( AMP_Options_Manager::is_stories_experience_enabled() && AMP_Story_Legacy_Post_Type::POST_TYPE_SLUG === get_post_type() )
			)
		);
