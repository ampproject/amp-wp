		...
		return array(
			...
			'styles_with_dynamic_elements' => array(
				implode( '', array(
					...
					'<style amp-custom>.amp-form-submit-success h1 { display: none; }</style>',
					'<style amp-custom>.amp-form-submitting h2 { display: block; }</style>',
					'</head><body>',
				...
				array(
					...
					'.amp-form-submit-success h1 {display:none}',
					'.amp-form-submitting h2 {display:block}',
				),
				array(),
			),
