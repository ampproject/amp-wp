...
class AMP_Story_Sanitizer_Test extends WP_UnitTestCase {
	...
	public function get_data() {
		return array(
			...
			'story_with_cta_layer_within_grid_layer_on_first_page' => array(
				'<amp-story-page><amp-story-grid-layer><p>Lorem Ipsum Demet Delorit.</p><amp-story-cta-layer><a href="">Foo</a></amp-story-cta-layer></amp-story-grid-layer></amp-story-page>',
				'<amp-story-page><amp-story-grid-layer><p>Lorem Ipsum Demet Delorit.</p></amp-story-grid-layer></amp-story-page>',
			),
			'story_with_cta_on_secomd_page' => array(
			...
			'story_with_cta_layer_within_grid_layer_on_second_page' => array(
				'<amp-story-page><amp-story-grid-layer><p>Lorem Ipsum Demet Delorit.</p></amp-story-grid-layer></amp-story-page><amp-story-page><amp-story-grid-layer><amp-story-cta-layer><a href="">Foo</a></amp-story-cta-layer></amp-story-grid-layer></amp-story-page>',
