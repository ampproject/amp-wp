...
class AMP_Tag_And_Attribute_Sanitizer_Test extends TestCase {
	...
	public function get_body_data() {
		return [
						...
						<amp-story standalone entity="User" entity-logo-src="https://example.com/logo/1x1.png" entity-url="https://example.com/profile/user" live-story-disabled supports-landscape title="My Story" publisher="The AMP Team" publisher-logo-src="https://example.com/logo/1x1.png" poster-portrait-src="https://example.com/my-story/poster/3x4.jpg" poster-square-src="https://example.com/my-story/poster/1x1.jpg" poster-landscape-src="https://example.com/my-story/poster/4x3.jpg" background-audio="my.mp3">
							...
							<amp-story-page id="my-second-page">
								...
								<amp-story-page-attachment layout="nodisplay" theme="dark" data-cta-text="Read more" data-title="My title" cta-image="https://example.com/image.png">
									...
									<amp-video src="https://amp-sample-videos.netlify.app/ForBiggerJoyrides.mp4" width="300" height="300" controls=""></amp-video>
									<p>And a tweet!</p>
							...
							<amp-story-page id="page1" auto-advance-after="video">
								<amp-story-grid-layer template="fill">
									<amp-video id="video" src="https://amp-sample-videos.netlify.app/ElephantsDream.mp4" poster="https://example.com/poster.jpg" width="1280" height="720" layout="responsive" autoplay captions-id="captions">
			...
			'button'                                       => [
				'<button on="tap:AMP.setState(foo=\'foo\', isButtonDisabled=true, textClass=\'redBackground\', imgSrc=\'https://ampbyexample.com/img/Shetland_Sheepdog.jpg\', imgSize=200, imgAlt=\'Sheepdog\', videoSrc=\'https://amp-sample-videos.netlify.app/ForBiggerJoyrides.mp4\')">Click me</button>',
				null,
			],
