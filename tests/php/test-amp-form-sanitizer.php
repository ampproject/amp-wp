	...
	public function get_data() {
		...
		return [
			...
			'form_with_upload' => [
				...
				'#' . preg_quote( '<form method="post" action-xhr="https://example.org/upload/?_wp_amp_action_xhr_converted=1" target="_top"><input type="file" name="upload"><button type="submit">Submit</button>', '#' ) . $form_template_pattern . '</form>#s',
			],
			'form_with_password' => [
				'<form action="https://example.org/login/" method="post"><input type="password" name="password"><button type="submit">Submit</button></form>',
				'#' . preg_quote( '<form method="post" action-xhr="https://example.org/login/?_wp_amp_action_xhr_converted=1" target="_top"><input type="password" name="password"><button type="submit">Submit</button>', '#' ) . $form_template_pattern . '</form>#s',
			],
