		...
		return [
			...
			'shortcode_with_valid_ids_in_legacy_mode' => [
				...
				<amp-carousel width="640" height="480" type="slides" layout="responsive">
					<figure class="slide"><a href="{{file_url1}}"><img width="100" height="100" src="{{file1}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' aria-describedby="gallery-1-{{id1}}" data-id="{{id1}}" layout="fill" object-fit="cover"></a>' . $amp_carousel_caption . '</figure>
					<figure class="slide"><a href="{{file_url2}}"><img width="640" height="480" src="{{file2}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' srcset="{{file2}}.jpg 640w, {{file2}}-300x225.jpg 300w" sizes="(max-width: 640px) 100vw, 640px" data-id="{{id2}}" layout="fill" object-fit="cover"></a></figure>
					<figure class="slide"><a href="{{file_url3}}"><img width="100" height="100" src="{{file3}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' data-id="{{id3}}" layout="fill" object-fit="cover"></a></figure>
				</amp-carousel>',
				true,
			],
			...
			'shortcode_with_carousel_linking_to_file' => [
				...
				'<style type="text/css"> #gallery-1 { margin: auto; } #gallery-1 .gallery-item { float: left; margin-top: 10px; text-align: center; width: 33%; } #gallery-1 img { border: 2px solid #cfcfcf; } #gallery-1 .gallery-caption { margin-left: 0; } /* see gallery_shortcode() in wp-includes/media.php */ </style>
				<amp-carousel width="640" height="480" type="slides" layout="responsive">
					<figure class="slide"><a href="{{file1}}.jpg"><img width="100" height="100" src="{{file1}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' aria-describedby="gallery-1-{{id1}}" data-id="{{id1}}" layout="fill" object-fit="cover"></a>' . $amp_carousel_caption . '</figure>
					<figure class="slide"><a href="{{file2}}.jpg"><img width="640" height="480" src="{{file2}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' srcset="{{file2}}.jpg 640w, {{file2}}-300x225.jpg 300w" sizes="(max-width: 640px) 100vw, 640px" data-id="{{id2}}" layout="fill" object-fit="cover"></a></figure>
					<figure class="slide"><a href="{{file3}}.jpg"><img width="100" height="100" src="{{file3}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' data-id="{{id3}}" layout="fill" object-fit="cover"></a></figure>
				</amp-carousel>',
			],
			'shortcode_with_lightbox'                 => [
				...
				<div data-amp-lightbox="true" id="gallery-1" class="gallery galleryid-0 gallery-columns-3 gallery-size-thumbnail">
					<dl class="gallery-item"><dt class="gallery-icon landscape">
						<img width="100" height="100" src="{{file1}}.jpg" class="attachment-thumbnail size-thumbnail" alt="Alt text" ' . $loading_attribute . ' aria-describedby="gallery-1-{{id1}}" data-id="{{id1}}" lightbox="">
					</dt><dd class="wp-caption-text gallery-caption" id="gallery-1-{{id1}}"> ' . self::CAPTION_TEXT . ' </dd></dl>
					<dl class="gallery-item"><dt class="gallery-icon landscape">
						<img width="150" height="150" src="{{file2}}-150x150.jpg" class="attachment-thumbnail size-thumbnail" alt="Alt text" ' . $loading_attribute . ' data-id="{{id2}}" srcset="{{file2}}.jpg 640w, {{file2}}-300x225.jpg 300w" sizes="(max-width: 640px) 100vw, 640px" lightbox="">
					</dt></dl>
					<dl class="gallery-item"><dt class="gallery-icon landscape">
						<img width="100" height="100" src="{{file3}}.jpg" class="attachment-thumbnail size-thumbnail" alt="Alt text" ' . $loading_attribute . ' data-id="{{id3}}" lightbox="">
					</dt></dl>
					<br style="clear: both">
				</div>',
			],
			...
			'shortcode_with_lightbox_and_carousel'    => [
				...
				<amp-carousel width="640" height="480" type="slides" layout="responsive" lightbox="">' .
					'<figure class="slide"><img width="100" height="100" src="{{file1}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' aria-describedby="gallery-1-{{id1}}" data-id="{{id1}}" layout="fill" object-fit="cover">' . $amp_carousel_caption . '</figure>' .
					'<figure class="slide"><img width="640" height="480" src="{{file2}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' srcset="{{file2}}.jpg 640w, {{file2}}-300x225.jpg 300w" sizes="(max-width: 640px) 100vw, 640px" data-id="{{id2}}" layout="fill" object-fit="cover"></figure>' .
					'<figure class="slide"><img width="100" height="100" src="{{file3}}.jpg" class="attachment-large size-large" alt="Alt text" ' . $loading_attribute . ' data-id="{{id3}}" layout="fill" object-fit="cover"></figure>' .
				'</amp-carousel>',
			],
