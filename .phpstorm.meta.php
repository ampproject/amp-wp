...
namespace PHPSTORM_META {
	...
	override(
		...
		map( [
			...
			'px.analyzer'                         => \AmpProject\AmpWP\PageExperience\Analyzer::class,
			'px.optimizer'                        => \AmpProject\AmpWP\PageExperience\Optimizer::class,
			...
			'rest.px.analysis_results_controller' => \AmpProject\AmpWP\PageExperience\AnalysisResultsRestController::class,
